...
from data_helper import BigruSeq2SeqData
...
class Trainer(object):
    ...
    def load_data(self):
        ...
        :return:
        """
        data_obj = BigruSeq2SeqData(self.config)
        return data_obj
    ...
    def create_model(self):
        ...
        :return:
        """
        model = Seq2SeqGru(config=self.config, vocab_size=self.vocab_size,
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(self.config["epochs"]):
                ...
                for batch in self.data_obj.next_batch(self.train_data,
                    ...
                    summary, loss, prediction = self.model.train(sess, batch)
