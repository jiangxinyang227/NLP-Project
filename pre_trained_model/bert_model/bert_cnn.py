...
tf.flags.DEFINE_bool("fine_tune", True, "fine tuning")
...
class ImdbProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        lines = self._read_txt(data_dir, "train_data.txt")
    ...
    def get_dev_examples(self, data_dir):
        lines = self._read_txt(data_dir, "eval_data.txt")
    ...
    def get_test_examples(self, data_dir):
        lines = self._read_txt(data_dir, "test_data.txt")
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    text_cnn = TextCNN(embedded_chars=embedding, filter_sizes=FLAGS.filter_sizes,
                       num_filter=FLAGS.num_filter, labels=labels,
                       num_label=num_labels, dropout_rate=FLAGS.dropout_rate,
                       max_len=FLAGS.max_seq_length, is_training=True)
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        (loss, logits, predictions) = create_model(
            ...
            num_labels, use_one_hot_embeddings, fine_tune)
